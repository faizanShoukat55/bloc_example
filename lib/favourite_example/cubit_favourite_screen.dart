...
class CubitFavouriteAppScreen extends StatefulWidget {
  const CubitFavouriteAppScreen({super.key});

  @override
  State<CubitFavouriteAppScreen> createState() => _FavouriteAppScreenState();
}

class _FavouriteAppScreenState extends State<CubitFavouriteAppScreen> {
  @override
  void initState() {
    super.initState();
    context.read<FavouriteCubit>().fetchList();
  }
          ...
          BlocBuilder<FavouriteCubit, FavouriteState>(builder: (context, state) {
            return Visibility(
              ...
              child: IconButton(
                ...
                onPressed: () {
                  context.read<FavouriteCubit>().deleteItem();
                },
              ),
            );
          })
